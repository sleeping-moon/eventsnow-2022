...
```
cd existing_repo
git remote add origin https://gitlab.com/nc-minsk-ec11-be/veal/eventsnow.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/nc-minsk-ec11-be/veal/eventsnow/-/settings/integrations)
